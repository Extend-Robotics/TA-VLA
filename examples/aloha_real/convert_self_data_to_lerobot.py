...
Example usage: uv run examples/aloha_real/convert_self_data_to_lerobot.py --raw-dir /path/to/raw/data --repo-id <org>/<dataset-name>
"""
...
def port_aloha(
    ...
    *,
    ...
    cameras = detect_cameras(hdf5_files)
